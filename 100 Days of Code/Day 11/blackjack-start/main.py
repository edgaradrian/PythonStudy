...
while not is_game_over:
  ...
  if user_cards_sum == 0 or user_cards_sum > 21 or computer_cards_sum == 0:
    is_game_over = True
  else:
...
def compare(computer_cards_sum, user_cards_sum):
...
compare(computer_cards_sum, user_cards_sum)
